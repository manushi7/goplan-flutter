                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          child: TextFormField(
                            decoration: ThemeHelper().textInputDecoration('Goal Title', 'Enter your title'),
                          ),
                        ...
                        Container(
                          child: TextFormField(
                            decoration: ThemeHelper().textInputDecoration('Goal Description', 'Describe your goal'),
                          ),
                          decoration: ThemeHelper().inputBoxDecorationShaddow(),
                        ),
                        ...
                        Container(
                          child: TextFormField(
                            ...
                            decoration: ThemeHelper().textInputDecoration("Create date", "Enter date"),
                            validator: (val) {
